...
<body>
	<div class="general">
		...
		<form class="formulario" action="menuRegistro.php" method="POST" enctype="multipart/form-data">
	        <h1>Registrar Pizza</h1>
	        <div class="contenedor">
	            <div class="input-contenedor">
	               <input type="text" name="pizza" placeholder="Nombre de la Pizza" required>
	            </div>

	            <div class="input-contenedor">
	               <textarea name="descripcion" placeholder="Descripcion de la pizza" required></textarea>
	            </div>

	            <h3>Imagen editada de la pizza</h3>
	            <div class="input-contenedor">
	            ...
	            <div class="input-contenedor">
	        <?php
            	$query = "SELECT * FROM `ingredientes-pizza` ORDER BY ingrediente";
                $result = $conexion->query($query);

                while ($mostrar = $result->fetch_assoc()) {
            		echo '<div style="padding: 5px;"><label><input type="checkbox" value="'.$mostrar['ingrediente'].'" name="opc'.$mostrar['id'].'"> '.$mostrar['ingrediente'].'</label></div>';
            	}
            ?>
	            </div>
